...
class EF_5GS3GPPNSC(LinFixedEF):
    ...
    class FiveGSNasSecurityContext(
        BER_TLV_IE,
        tag=0xA0,
        nested=[
            NgKSI,
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(
            fid, sfid=sfid, name=name, desc=desc, rec_len=rec_len, **kwargs
        )
...
class HomeNetPubKeyList(BER_TLV_IE, tag=0xA1, nested=[HomeNetPubKeyId, HomeNetPubKey]):
    pass
...
class EF_LI(TransRecEF):
    def __init__(
        ...
        super().__init__(
            fid, sfid=sfid, name=name, desc=desc, size=size, rec_len=rec_len
        )
    ...
    class AddlShellCommands(CommandSet):
        ...
        def do_ust_service_check(self, arg):
            ...
            if 46 in active_services and not 45 in active_services:
                self._cmd.perror(
                    "ERROR: Service 46 available, but it requires Service 45"
                )
                num_problems += 1
            ...
            if 125 in active_services and not 124 in active_services:
                self._cmd.perror(
                    "ERROR: Service 125 is ignored as Service 124 not available"
                )
                num_problems += 1
            ...
            if "ADF.ISIM" in app_names:
                for s in non_isim_services:
                    if s in active_services:
                        self._cmd.perror(
                            "ERROR: Service %u shall not be available as ISIM application is present"
                            % s
                        )
                        num_problems += 1
            self._cmd.poutput(
                "===> %u service / file inconsistencies detected" % num_problems
            )
...
class EF_ECC(LinFixedEF):
    ...
    def __init__(
        self, fid="6fb7", sfid=0x01, name="EF.ECC", desc="Emergency Call Codes"
    ):
    ...
    def _decode_record_bin(self, in_bin, **kwargs):
        ...
        ret = {
            "call_code": parse_construct(EF_ECC.cc_construct, code),
            "service_category": parse_construct(
                EF_ECC.category_construct, svc_category
            ),
        }
    ...
    def __init__(
        ...
        self._construct = BitStruct(
            ...
            / Bytewise(
                FlagsEnum(
                    Int16ub,
                    ciphering_indicator=1,
                    csg_display_control=2,
                    prose_services=4,
                    extended_drx=8,
                )
            ),
...
class EF_PSLOCI(TransparentEF):
    def __init__(
        ...
        sfid=0x0C,
        name="EF.PSLOCI",
        desc="PS Location information",
        size=(14, 14),
    ):
        super().__init__(fid, sfid=sfid, name=name, desc=desc, size=size)
        self._construct = Struct(
            "ptmsi" / HexAdapter(Bytes(4)),
...
class EF_ICI(CyclicEF):
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(
            fid=fid, sfid=sfid, name=name, desc=desc, rec_len=rec_len, **kwargs
        )
        self._construct = Struct(
            "alpha_id" / HexAdapter(Bytes(this._.total_len - 28)),
...
class EF_OCI(CyclicEF):
    def __init__(
        ...
        **kwargs
        ...
        self._construct = Struct(
            "alpha_id" / HexAdapter(Bytes(this._.total_len - 27)),
            "len_of_bcd_contents" / Int8ub,
            "ton_npi" / Int8ub,
            "call_number" / BcdAdapter(Bytes(10)),
            "cap_cfg2_record_id" / Int8ub,
...
class EF_CCP2(LinFixedEF):
    def __init__(
        ...
        sfid=0x16,
        name="EF.CCP2",
        desc="Capability Configuration Parameters 2",
        **kwargs
    ):
        super().__init__(
            fid=fid, sfid=sfid, name=name, desc=desc, rec_len=(15, None), **kwargs
        )
...
class EF_ACL(TransparentEF):
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(fid, sfid=sfid, name=name, desc=desc, size=size, **kwargs)
        self._construct = Struct(
            "num_of_apns" / Int8ub, "tlvs" / HexAdapter(GreedyBytes)
        )
...
class EF_RPLMNAcT(TransRecEF):
    def __init__(
        ...
        size=(2, 4),
        rec_len=2,
        desc="RPLMN Last used Access Technology",
        **kwargs
    ):
        super().__init__(
            fid, sfid=sfid, name=name, desc=desc, size=size, rec_len=rec_len, **kwargs
        )
...
class EF_MSK(LinFixedEF):
    def __init__(
        ...
        sfid=None,
        name="EF.MSK",
        desc="MBMS Service Key List",
        **kwargs
    ):
        super().__init__(
            fid=fid, sfid=sfid, name=name, desc=desc, rec_len=(20, None), **kwargs
        )
        msk_ts_constr = Struct("msk_id" / Int32ub, "timestamp_counter" / Int32ub)
        self._construct = Struct(
            "key_domain_id" / HexAdapter(Bytes(3)),
            "num_msk_id" / Int8ub,
...
class EF_MUK(LinFixedEF):
    ...
    def __init__(
        self, fid="6fd8", sfid=None, name="EF.MUK", desc="MBMS User Key", **kwargs
    ):
        super().__init__(
            fid=fid, sfid=sfid, name=name, desc=desc, rec_len=(None, None), **kwargs
        )
...
class EF_GBANL(LinFixedEF):
    ...
    def __init__(
        self, fid="6fda", sfid=None, name="EF.GBANL", desc="GBA NAF List", **kwargs
    ):
        super().__init__(
            fid=fid, sfid=sfid, name=name, desc=desc, rec_len=(None, None), **kwargs
        )
...
class EF_NCP_IP(LinFixedEF):
    class DataDestAddrRange(TLV_IE, tag=0x83):
        _construct = Struct(
            "type_of_address" / Enum(Byte, IPv4=0x21, IPv6=0x56),
    ...
    class EF_NCP_IP_Collection(
        TLV_IE_Collection, nested=[AccessPointName, Login, Password, BearerDescription]
    ):
        pass
...
class EF_EPSNSC(LinFixedEF):
    ...
    class EPS_NAS_Security_Context(
        BER_TLV_IE,
        tag=0xA0,
        nested=[KSI_ASME, K_ASME, UplinkNASCount, DownlinkNASCount, IDofNASAlgorithms],
    ):
        pass
...
class EF_IPS(CyclicEF):
    def __init__(
        ...
        **kwargs
        ...
        self._construct = Struct(
            "status" / PaddedString(2, "ascii"), "link_to_ef_ipd" / Int8ub, "rfu" / Byte
        )
...
class EF_ePDGId(TransparentEF):
    class ePDGId(BER_TLV_IE, tag=0x80, nested=[]):
        _construct = Struct(
            "type_of_ePDG_address" / Enum(Byte, FQDN=0, IPv4=1, IPv6=2),
            "ePDG_address"
            / Switch(
...
class EF_eAKA(TransparentEF):
    def __init__(
        ...
        name="EF.eAKA",
        size=(1, 1),
        desc="enhanced AKA support",
        **kwargs
    ):
        super().__init__(fid, sfid=sfid, name=name, desc=desc, size=size, **kwargs)
        self._construct = BitStruct(
            "rfu" / BitsRFU(7), "enhanced_sqn_calculation_supported" / Bit
        )
    ...
    def __init__(self, fid="5F3B", name="DF.GSM-ACCESS", desc="GSM Access", **kwargs):
        ...
        files = [
            ...
            EF_Kc(
                ...
                sfid=0x02,
                name="EF.KcGPRS",
                desc="GPRS Ciphering key KcGPRS",
                service=27,
            ),
...
class EF_UAC_AIC(TransparentEF):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(fid, sfid=sfid, name=name, desc=desc, size=size, **kwargs)
        cfg_constr = FlagsEnum(
            Byte, multimedia_priority_service=1, mission_critical_service=2
        )
...
class EF_OPL5G(LinFixedEF):
    def __init__(
        ...
        sfid=0x08,
        name="EF.OPL5G",
        desc="5GS Operator PLMN List",
        **kwargs
    ):
        super().__init__(
            fid=fid, sfid=sfid, name=name, desc=desc, rec_len=(10, None), **kwargs
        )
        Tai = Struct(
            "mcc_mnc" / BcdAdapter(Bytes(3)),
...
class EF_Routing_Indicator(TransparentEF):
    def __init__(
        ...
        fid="4f0a",
        sfid=0x0A,
        name="EF.Routing_Indicator",
        desc="Routing Indicator",
        **kwargs
    ):
        super().__init__(fid, sfid=sfid, name=name, desc=desc, **kwargs)
        ...
        self._construct = Struct(
            "routing_indicator" / Rpad(BcdAdapter(Bytes(2)), "f", 2),
...
class EF_CAG(TransparentEF):
    def __init__(
        ...
        sfid=0x0D,
        name="EF.CAG",
        desc="Pre-configured CAG information list EF",
        **kwargs
    ):
        super().__init__(fid, sfid=sfid, name=name, desc=desc, **kwargs)
...
class EF_DRI(TransparentEF):
    def __init__(
        ...
        sfid=0x0F,
        name="EF.DRI",
        desc="Disaster roaming information EF",
        **kwargs
    ):
        super().__init__(fid, sfid=sfid, name=name, desc=desc, **kwargs)
        self._construct = Struct(
            "disaster_roaming_enabled" / Byte,
            "parameters_indicator_status"
            / FlagsEnum(
                Byte,
...
class EF_PWS_SNPN(TransparentEF):
    def __init__(
        ...
        sfid=0x01,
        name="EF.PWS_SNPN",
        desc="Public Warning System in SNPNs",
        **kwargs
    ):
        super().__init__(fid, sfid=sfid, name=name, desc=desc, **kwargs)
        self._construct = Struct(
            "pws_config_in_snpns"
            / FlagsEnum(
                Byte, ignore_all_pws_in_subscribed=1, ignore_all_pws_in_non_subscribed=2
            )
        )
...
class EF_NID(LinFixedEF):
    def __init__(
        ...
        sfid=0x02,
        name="EF.NID",
        desc="Network Identifier for SNPN",
        **kwargs
    ):
        super().__init__(fid, sfid=sfid, name=name, desc=desc, rec_len=(6, 6), **kwargs)
        self._construct = Struct(
            "assignment_mode"
            / Enum(Byte, coordinated_ass_opt1=0, self_ass=1, coordinated_ass_opt2=2),
...
class DF_SNPN(CardDF):
    def __init__(
        self, fid="5fe0", name="DF.SNPN", desc="Files for SNPN purpose", **kwargs
    ):
...
class EF_5G_PROSE_ST(EF_UServiceTable):
    def __init__(self, **kwargs):
        super().__init__(
            ...
            sfid=0x01,
            name="EF.5G_PROSE_ST",
            desc="5G ProSe Service Table",
            size=(1, 2),
            table=EF_5G_PROSE_ST_map,
            **kwargs
        )
        # add those commands to the general commands of a TransparentEF
        self.shell_commands += [self.AddlShellCommands()]
...
class EF_5G_PROSE_DD(TransparentEF):
    ...
    class ProSeConfigForDirectDiscovery(
        BER_TLV_IE,
        tag=0xA0,
        nested=[
            ServedByNgRan,
    ...
    def __init__(
        ...
        sfid=0x02,
        name="EF.5G_PROSE_DD",
        desc="5G ProSe configuration data for direct discovery",
        **kwargs
    ):
        super().__init__(fid, sfid=sfid, name=name, desc=desc, **kwargs)
...
class EF_5G_PROSE_DC(TransparentEF):
    ...
    class ProSeIdToNrTxProfileForBroadcastAndGroupcastMappingRules(
        BER_TLV_IE, tag=0x91
    ):
        pass

    class ProSeConfigForDirectCommunication(
        BER_TLV_IE,
        tag=0xA0,
        nested=[
            EF_5G_PROSE_DD.ServedByNgRan,
    ...
    def __init__(
        ...
        sfid=0x03,
        name="EF.5G_PROSE_DC",
        desc="5G ProSe configuration data for direct communication",
        **kwargs
    ):
        super().__init__(fid, sfid=sfid, name=name, desc=desc, **kwargs)
        # contains TLV structure despite being TransparentEF, not BER-TLV ?!?
...
class EF_5G_PROSE_U2NRU(TransparentEF):
    ...
    class ProSeConfigDataForUeToNetworkRelayUe(
        BER_TLV_IE,
        tag=0xA0,
        nested=[
            EF_5G_PROSE_DD.ServedByNgRan,
    ...
    def __init__(
        ...
        fid="4f04",
        sfid=0x04,
        name="EF.5G_PROSE_U2NRU",
        desc="5G ProSe configuration data for UE-to-network relay UE",
        **kwargs
    ):
        super().__init__(fid, sfid=sfid, name=name, desc=desc, **kwargs)
        # contains TLV structure despite being TransparentEF, not BER-TLV ?!?
...
class EF_5G_PROSE_RU(TransparentEF):
    ...
    class ProSeConfigDataForRemoteUe(
        BER_TLV_IE,
        tag=0xA0,
        nested=[
            EF_5G_PROSE_DD.ServedByNgRan,
    ...
    def __init__(
        ...
        sfid=0x05,
        name="EF.5G_PROSE_RU",
        desc="5G ProSe configuration data for remote UE",
        **kwargs
    ):
        super().__init__(fid, sfid=sfid, name=name, desc=desc, **kwargs)
        # contains TLV structure despite being TransparentEF, not BER-TLV ?!?
...
class EF_5G_PROSE_UIR(TransparentEF):
    ...
    def __init__(
        ...
        fid="4f06",
        sfid=0x06,
        name="EF.5G_PROSE_UIR",
        desc="5G ProSe configuration data for usage information reporting",
        **kwargs
    ):
        super().__init__(fid, sfid=sfid, name=name, desc=desc, **kwargs)
        # contains TLV structure despite being TransparentEF, not BER-TLV ?!?
...
class DF_5G_ProSe(CardDF):
    def __init__(
        ...
        fid="5ff0",
        name="DF.5G_ProSe",
        desc="Files for 5G ProSe purpose",
        **kwargs
    ):
        super().__init__(fid=fid, name=name, desc=desc, **kwargs)
        files = [
...
class EF_5GSEDRX(TransparentEF):
    def __init__(
        ...
        sfid=0x10,
        name="EF.5GSEDRX",
        desc="5GS eDRX Parameters",
        **kwargs
    ):
        super().__init__(fid, sfid=sfid, name=name, desc=desc, **kwargs)
        self._construct = Struct(
            "5gs_rat_type" / FlagsEnum(Byte, ng_ran=1, sat_ng_ran=2),
...
class EF_5GNSWO_CONF(TransparentEF):
    def __init__(
        ...
        sfid=0x11,
        name="EF.5GNSWO_CONF",
        desc="5G Non-Seamless WLAN Offload configuration",
        **kwargs
    ):
        super().__init__(fid, sfid=sfid, name=name, desc=desc, **kwargs)
        self._construct = Struct(
            "5g_nswo_usage_ind" / Enum(Byte, disabled=0, enabled=1)
        )
...
class EF_MCHPPLMN(TransparentEF):
    def __init__(
        ...
        sfid=0x15,
        name="EF.MCHPPLMN",
        desc="Multiplier Coefficient for Higher Priority PLMN search",
        **kwargs
    ):
        super().__init__(fid, sfid=sfid, name=name, desc=desc, **kwargs)
...
class EF_KAUSF_DERIVATION(TransparentEF):
    def __init__(
        ...
        desc="K_AUSF derivation configuration",
        **kwargs
    ):
        super().__init__(fid, sfid=sfid, name=name, desc=desc, **kwargs)
        self._construct = Struct(
            "k_ausf_deriv_cfg" / FlagsEnum(Byte, use_msk=1),
...
class DF_WLAN(CardDF):
    def __init__(
        self, fid="5f40", name="DF.WLAN", desc="Files for WLAN purpose", **kwargs
    ):
        super().__init__(fid=fid, name=name, desc=desc, **kwargs)
        files = [
            ...
            TransparentEF(
                "4f46", 0x06, "EF.WRI", "WLAN Reauthentication Identity", service=66
            ),
            LinFixedEF(
                "4f47",
                0x07,
            ...
            TransparentEF(
                "4f49", 0x09, "EF.WHPI", "I-WLAN HPLMN Priority Indication", service=83
            ),
            TransparentEF(
                "4f4a", 0x0A, "EF.WLRPLMN", "I-WLAN Last Registered PLMN", service=84
            ),
            TransparentEF(
                "4f4b", 0x0B, "EF.HPLMNDAI", "HPLMN Direct Access Indicator", service=88
            ),
        ]
        self.add_files(files)
...
class DF_HNB(CardDF):
    def __init__(
        self, fid="5f50", name="DF.HNB", desc="Files for HomeNodeB purpose", **kwargs
    ):
        super().__init__(fid=fid, name=name, desc=desc, **kwargs)
        files = [
            ...
            LinFixedEF(
                "4f86", 0x06, "EF.OHNBN", "Operator Home NodeB Name", service=90
            ),
        ]
        self.add_files(files)
...
class DF_ProSe(CardDF):
    def __init__(
        self, fid="5f90", name="DF.ProSe", desc="Files for ProSe purpose", **kwargs
    ):
        super().__init__(fid=fid, name=name, desc=desc, **kwargs)
        files = [
            ...
            TransparentEF(
                "4f11", 0x11, "EF.UIRC", "ProSe UsageInformationReportingConfiguration"
            ),
            LinFixedEF(
                "4f12",
                0x12,
                "EF.PROSE_GM_DISCOVERY",
...
class DF_SAIP(CardDF):
    ...
    def __init__(
        ...
        fid="5FD0",
        name="DF.SAIP",
        desc="SIMalliance Interoperable Profile",
        **kwargs
    ):
        super().__init__(fid=fid, name=name, desc=desc, **kwargs)
        files = [
...
class ADF_USIM(CardADF):
    def __init__(
        ...
        files = [
            ...
            TransparentEF(
                "6f3e", None, "EF.GID1", "Group Identifier Level 1", service=17
            ),
            TransparentEF(
                "6f3f", None, "EF.GID2", "Group Identifier Level 2", service=18
            ),
            EF_SPN(service=19),
            TransparentEF(
                "6f41",
            ...
            EF_PSLOCI(),
            EF_ADN(
                "6f3b", None, "EF.FDN", "Fixed Dialling Numbers", service=[2, 89], ext=2
            ),
            ...
            EF_OPL(service=46),
            EF_ADN(
                "6fc7", None, "EF.MBDN", "Mailbox Dialling Numbers", service=47, ext=6
            ),
            ...
            EF_VGCSS(
                "6fb4", None, "EF.VBSS", "Voice Broadcast Service Status", service=58
            ),
            ...
            TransparentEF(
                "6fde", None, "EF.SPNI", "Service Provider Name Icon", service=78
            ),
            LinFixedEF("6fdf", None, "EF.PNNI", "PLMN Network Name Icon", service=79),
            EF_NCP_IP(service=80),
            EF_EPSLOCI(
                "6fe3", 0x1E, "EF.EPSLOCI", "EPS location information", service=85
            ),
            EF_EPSNSC(service=85),
            TransparentEF(
                "6fe6", None, "EF.UFC", "USAT Facility Control", size=(1, 16)
            ),
            TransparentEF(
                "6fe8",
                None,
            ...
            EF_PWS(service=97),
            LinFixedEF(
                "6fed", None, "EF.FDNURI", "Fixed Dialling Numbers URI", service=(2, 99)
            ),
            LinFixedEF(
                "6fee",
                None,
    ...
    class AddlShellCommands(CommandSet):
        ...
        term_prof_parser.add_argument(
            "PROFILE", help="Hexstring of encoded terminal profile"
        )
        ...
        envelope_parser.add_argument(
            "PAYLOAD", help="Hexstring of encoded payload to ENVELOPE"
        )
        ...
        def do_get_identity(self, opts):
            ...
            do_d = do.to_dict()
            self._cmd.poutput(
                "SUCI TLV Data Object: %s" % do_d["suci__tlv_data_object"]
            )
