...
# TYPE_UM_BURST
gsmtap_subtype_burst_construct = Enum(
    Int8ub,
    unknown=0x00,
    fcch=0x01,
    partial_sch=0x02,
...
gsmtap_subtype_wimax_burst_construct = Enum(
    Int8ub, cdma_code=0x10, fch=0x11, ffb=0x12, pdu=0x13, hack=0x14, phy_attributes=0x15
)

# GSMTAP_CHANNEL_*
gsmtap_subtype_um_construct = Enum(
    Int8ub,
    unknown=0x00,
    bcch=0x01,
    ccch=0x02,
...
# GSMTAP_SIM_*
gsmtap_subtype_sim_construct = Enum(
    Int8ub,
    apdu=0x00,
    atr=0x01,
    pps_req=0x02,
...
gsmtap_subtype_tetra_construct = Enum(
    Int8ub,
    bsch=0x01,
    aach=0x02,
    sch_hu=0x03,
...
gsmtap_subtype_gmr1_construct = Enum(
    Int8ub,
    unknown=0x00,
    bcch=0x01,
    ccch=0x02,
...
gsmtap_subtype_e1t1_construct = Enum(
    Int8ub, lapd=0x01, fr=0x02, raw=0x03, trau16=0x04, trau8=0x05
)

gsmtap_arfcn_construct = BitStruct(
    "pcs" / Flag, "uplink" / Flag, "arfcn" / BitsInteger(14)
)

gsmtap_hdr_construct = Struct(
    "version" / Int8ub,
    "hdr_len" / Int8ub,
...
gsmtap_osmocore_log_hdr_construct = Struct(
    "ts" / osmocore_log_ts_construct,
...
class GsmtapSource:
    ...
    def read_packet(self) -> GsmtapMessage:
        ...
        if gsmtap_msg.decoded["version"] != 0x02:
            raise ValueError(
                "Unknown GSMTAP version 0x%02x" % gsmtap_msg.decoded["version"]
            )
