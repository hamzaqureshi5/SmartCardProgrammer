...
class EF_IMPI(TransparentEF):
    ...
    def __init__(
        ...
        sfid=0x02,
        name="EF.IMPI",
        desc="IMS private user identity",
        **kwargs
    ):
...
class EF_IST(EF_UServiceTable):
    def __init__(self, **kwargs):
        super().__init__(
            "6f07", 0x07, "EF.IST", "ISIM Service Table", (1, None), EF_IST_map
        )
...
class EF_PCSCF(LinFixedEF):
    ...
    def __init__(
        self, fid="6f09", sfid=None, name="EF.P-CSCF", desc="P-CSCF Address", **kwargs
    ):
        super().__init__(fid=fid, sfid=sfid, name=name, desc=desc, **kwargs)
...
class EF_GBABP(TransparentEF):
    def __init__(
        self, fid="6fd5", sfid=None, name="EF.GBABP", desc="GBA Bootstrapping", **kwargs
    ):
        super().__init__(fid=fid, sfid=sfid, name=name, desc=desc, **kwargs)
...
class EF_GBANL(LinFixedEF):
    def __init__(
        self, fid="6fd7", sfid=None, name="EF.GBANL", desc="GBA NAF List", **kwargs
    ):
        super().__init__(fid=fid, sfid=sfid, name=name, desc=desc, **kwargs)
...
class EF_UICCIARI(LinFixedEF):
    ...
    def __init__(
        self, fid="6fe7", sfid=None, name="EF.UICCIARI", desc="UICC IARI", **kwargs
    ):
        super().__init__(fid=fid, sfid=sfid, name=name, desc=desc, **kwargs)
...
class EF_IMSConfigData(BerTlvEF):
    ...
    class ImsConfigDataCollection(
        TLV_IE_Collection, nested=[ImsConfigDataEncoding, ImsConfigData]
    ):
        pass
...
class EF_XCAPConfigData(BerTlvEF):
    ...
    # pylint: disable=undefined-variable
    class XcapConnParamsPolicyPart(
        BER_TLV_IE,
        tag=0xA1,
        nested=[
            Access,
    ...
    class XcapConnParamsPolicy(
        BER_TLV_IE,
        tag=0xA0,
        nested=[AccessForXCAP, NumberOfXcapConnParPolicy, XcapConnParamsPolicyPart],
    ):
        pass
...
class EF_WebRTCURI(TransparentEF):
    ...
    def __init__(
        self, fid="6ffa", sfid=None, name="EF.WebRTCURI", desc="WebRTC URI", **kwargs
    ):
        super().__init__(fid=fid, sfid=sfid, name=name, desc=desc, **kwargs)
...
class EF_MuDMiDConfigData(BerTlvEF):
    ...
    # pylint: disable=undefined-variable
    class MudMidConfigDataCollection(
        TLV_IE_Collection, nested=[MudMidConfigDataEncoding, MudMidConfigData]
    ):
        pass
